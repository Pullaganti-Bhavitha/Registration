...
public class StudentController {
	...
	public String addStudent(@ModelAttribute Registration st, Model model) {
	...
	public String searchStudent(@RequestParam int id, Model model) {
		Registration st=service.searchStudent(id);
		model.addAttribute("student",st);
		return "displayStudent";
	}
	
	@PostMapping("/updateStudent")
	public String updateStudent(@ModelAttribute Registration st, Model model) {
	...
	public String fetchAllStudents(Model model){
		List<Registration> stList = service.fetchAllStudents();
